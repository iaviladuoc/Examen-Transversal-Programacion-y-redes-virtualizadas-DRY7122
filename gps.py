...
##loc1 = "Santiago"
##loc2 = "Cusco"
key = "937fb7c0-c7de-48bc-918a-0189528809d2" ## Clave de API
...
def geocoding (location, key):
    ...
    if json_status == 200 and len (json_data ["hits"]) != 0:
        ...
        if len(state) !=0 and len(country) !=0:
            ...
            new_loc = name
        print("Ubicación de salida:  " + new_loc + " (Location Type: " + value + ")\n" + url)
    else:
        lat="null"
        lng="null"
        new_loc=location
...
while True:
    ...
    loc1 = input("Punto de inicio del viaje: ")
    if loc1 == "exit" or loc1 == "e":
        break
    orig = geocoding(loc1, key)
    #print(orig)

    loc2 = input("Destino del viaje: ")
    if loc2 == "exit" or loc2 == "e":
        break
    ...
    if orig[0] == 200 and dest[0] == 200:
        ...
        if paths_status == 200:
            ...
            print("Duración del viaje " + str(paths_data["paths"][0]["time"]) + "millisec")
            print("=================================================")
